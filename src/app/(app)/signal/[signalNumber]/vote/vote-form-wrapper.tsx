...
export function VoteFormWrapper({
  ...
  const t = {
    ...
    kr: {
      ...
      whyPlaceholder: "간단히 이유를 남겨주세요...",
      submitVote: "의견 제출하기",
      submitting: "제출 중...",
      youreIn: "의견을 남겨주셨습니다.",
      perspectiveRecorded: "참여해 주셔서 감사합니다.",
      resultsShared: "투표 마감 후 결과를 공유해 드립니다.",
      signalClosed: "이번 Signal은 마감되었습니다",
      stayTuned: "다음 Signal도 함께해 주세요 — 참여하시면 리더들의 생각을 직접 확인하실 수 있습니다.",
      viewPastResults: "지난 결과 보기",
      membersOnly: "멤버 전용 대화입니다",
      membersOnlyDesc: "Elev8 Signal은 시니어 테크 리더들의 솔직한 생각을 담습니다 — 검증된 멤버만 참여할 수 있습니다. 관심이 있으신가요?",
